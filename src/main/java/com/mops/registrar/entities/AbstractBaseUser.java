...
/**
 * An abstract implementation of {@link BaseUser}
 * 
 * @author dylants
 * 
 */
public abstract class AbstractBaseUser extends AbstractBaseEntity implements BaseEntity, UserDetails,
     ...
     */
    public AbstractBaseUser(Set<GrantedAuthority> authorities) {
